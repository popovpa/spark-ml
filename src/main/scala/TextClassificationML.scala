...
object TextClassificationML extends App {
  ...
  val Array(df1, test1) = VKPosts.getTrainDaraFrame("data/text/g1/10*.txt", 0).randomSplit(Array(0.9, 0.1))
  val Array(df2, test2) = VKPosts.getTrainDaraFrame("data/text/g2/10*.txt", 1).randomSplit(Array(0.9, 0.1))
 ...
 // training = training.union(df3)
  ...
  val test = spark.createDataFrame(Seq(
    //1
    (4L, "СВОБОДНАЯ МАРЫСЯ! <br><br>Я иногда бываю удивительно своевременна.<br>1. С сегодняшнего вечера я в Мск. Обратно в понедельник или вторник вечером.<br><br>2. Доступна для встреч, начиная со второй половины воскресенья.<br><br>3. Не хочет ли кто-нибудь вписать меня с вс на пн и потенциально с пн на вт?<br><br>4. Собственно если на вторник придумаются планы - поеду обратно во вторник. Если не придумаются - в понедельник.<br><br>Понять надо до завтрашнего утра, чтобы успеть купить билет обратный до отъезда на полигон."),
    (4L, "Правильно \\/ Неправильно))) Смотрим!!! Запоминаем"),
    (4L, "Новая коллекция белых портупей В наличии в нашем шоуруме"),
    (4L, "Друзья!<br>Я учусь на 3 курсе педагогического колледжа и сейчас активно ищу ученика  1–6 класса. Владею всеми стандартными школьными предметами. ( Французский, древнегреческий и кибербезопасность в них не входят☺)  <br>Могу забирать с доп. занятий и делать домашние задания."),
